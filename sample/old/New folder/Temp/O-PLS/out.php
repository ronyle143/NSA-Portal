...
<head>
	...
	?>
	<?php include_once "blocks/function_out.php"; ?>
	<meta charset='UTF-8'>
	<title>O-PLS - Log-Out Property</title>
...
<!--------------------------------------------------------------------------------------------------------------------------------->
							<table bgcolor='<?php printf($_SESSION['color_2'])?>' cellpadding=5 cellspacing=2>
								<tr>
									<td colspan=2>
										<b><font size=8 color='<?php printf($_SESSION['color_1'])?>'>Log-Out Property</font></b>
									</td>
								</tr>
								<tr>
									<td align=right>
										<font color='<?php printf($_SESSION['color_1'])?>'>Prop no.:</font>
										<font color=red>*</font>
									</td>
									<td>
										<input type='TEXT' value='' placeholder='Prop no.' name='out_propno'>
									</td>
								</tr>
								<tr>
									<td align=right>
									...
									<td>
										<input type='TEXT' value='' placeholder='Name' name='out_outname'>
									</td>
								</tr>
								<tr>
									<td align=right>
									...
									<td>
										<input type='PASSWORD' value='' placeholder='Password' name='out_pass'>
									</td>
								</tr>
								<tr>
									<td colspan=2 align=center>
										<input type='submit' value='Ok' name='out'>
									</td>
								</tr>
							</table>
<!--------------------------------------------------------------------------------------------------------------------------------->
